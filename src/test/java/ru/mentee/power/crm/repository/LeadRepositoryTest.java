...
class LeadRepositoryTest {
  ...
  void shouldReturnAllLeads_whenMultipleLeadsSaved() {
    Lead lead1 =
        new Lead(UUID.randomUUID(), "iventalll@gmail.com", "+7911", "Megacorp", LeadStatus.NEW);
    Lead lead2 =
        new Lead(UUID.randomUUID(), "iventalll@gmail.com", "+7911", "Megacorp", LeadStatus.NEW);
    Lead lead3 =
        new Lead(UUID.randomUUID(), "iventalll@gmail.com", "+7911", "Megacorp", LeadStatus.NEW);
  ...
  void shouldOverwriteLead_whenSaveWithSameId() {
    UUID id = UUID.randomUUID();
    Lead lead1 = new Lead(id, "iventalll@gmail.com", "+7911", "Megacorp", LeadStatus.NEW);
    Lead lead2 = new Lead(id, "ivental@gmail.com", "+7911", "Megacorp", LeadStatus.NEW);
    repository.save(lead1);
    repository.save(lead2);
