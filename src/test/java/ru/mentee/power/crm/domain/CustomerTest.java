...
public class CustomerTest {
  ...
  void shouldThrowException_whenIdIsNull() {
    ...
    assertThatThrownBy(() -> new Customer(null, contact, address, "SILVER"))
  ...
  void shouldThrowException_whenContactIsNull() {
    ...
    assertThatThrownBy(() -> new Customer(UUID.randomUUID(), null, address, "SILVER"))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  void shouldThrowException_whenBillingAddressIsNull() {
    ...
    assertThatThrownBy(() -> new Customer(UUID.randomUUID(), contact, null, "SILVER"))
        .isInstanceOf(IllegalArgumentException.class)
  ...
  void shouldThrowException_whenLoyaltyTierIsNull() {
    ...
    assertThatThrownBy(() -> new Customer(UUID.randomUUID(), contact, address, null))
        .isInstanceOf(IllegalArgumentException.class)
