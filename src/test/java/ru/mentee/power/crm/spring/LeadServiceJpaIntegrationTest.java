...
class LeadServiceJpaIntegrationTest {
  ...
  @Autowired private DealServiceJpa dealService;

  @Autowired private LeadRepositoryJpa leadRepository;

  @Autowired private DealRepositoryJpa dealRepository;
  ...
  void convertLeadToDeal_shouldRollbackOnConstraintViolation() {
    ...
    assertEquals(originalStatus, updatedLead.getStatus(), "Статус лида не должен измениться");
