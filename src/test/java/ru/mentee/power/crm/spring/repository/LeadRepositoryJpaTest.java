...
public class LeadRepositoryJpaTest {
  ...
  void setUpForDerivedTests() {
    Company company1 = Company.builder().name("Arasaka").build();
    ...
    Company company2 = Company.builder().name("Militech").build();
  ...
  void findByStatusAndCompany_shouldReturnMatchingLeads() {
    Company company = companyRepository.save(Company.builder().name("Arasaka").build());
    Lead lead =
        Lead.builder()
