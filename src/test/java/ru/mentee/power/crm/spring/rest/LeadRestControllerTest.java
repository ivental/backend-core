...
public class LeadRestControllerTest {
    ...
    @MockitoBean
    private CompanyServiceJpa companyService;
    ...
    @MockitoBean
    private DealControllerJpa dealControllerJpa;

    @MockitoBean
    private DealController dealController;

    @MockitoBean
    private LeadControllerJpa leadControllerJpa;
    ...
    void shouldReturn200_whenUpdateExistingLead() throws Exception {
        UUID id = UUID.randomUUID();
        Lead leadToUpdate = Lead.builder()
                .email("ivi@gmail.com")
                .phone("+7912")
                .company(Company.builder().id(UUID.randomUUID()).build())
